...
public:
    ...
    bool SetImageInfo(EtronDIImageType::Value imageType,
...
private:
    virtual int MJPEG_Covert_TruboJPG(BYTE *pMJPEG, int nMJPEGSize, unsigned char *pRGB, unsigned int nWidth, unsigned int nHeight);
private:
    void *m_pTjHandle;
};

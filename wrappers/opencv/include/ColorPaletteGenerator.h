...
public:
    ...
    static void DmGrayMode14(RGBQUAD *palette, unsigned short zFar, unsigned short zNear);
    static void DmColorMode14(RGBQUAD *palette, unsigned short zFar, unsigned short zNear);

...
class Device(object):
    ...
    * Depth information
    ...
    def __init__(self, camera_index=0):
        system = EYS3DSystem()
        self.__camera_device = system.get_camera_device(camera_index)
    ...
    def get_usb_type(self, ):
        return self.__camera_device.get_usb_port_type()

    def get_exposure_range(self):
        try:
            ret = eys3dPy.get_exposure_range()
            if ret is None:
                raise Exception("get exposure range error!")
            else:
                return ret
        except Exception as e:
            raise e

...
#include "eys3d_depth/internal/image_utils.h"
#include "eys3d_depth/internal/motions.h"
#include "eys3d_depth/internal/location.h"
#include "eys3d_depth/internal/distance.h"
...
#define STREAM_ASYNC_MAX_SIZE 10  // latest
...
void CameraPrivate::SetIRMaxValue(
    const std::uint16_t &value) {
  device_->SetIRMaxValue(value);
}

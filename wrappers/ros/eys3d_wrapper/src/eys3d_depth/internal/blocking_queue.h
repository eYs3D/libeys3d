...
#ifndef EYS3D_INTERNAL_BLOCKING_QUEUE_H_
#define EYS3D_INTERNAL_BLOCKING_QUEUE_H_
#pragma once
...
class BlockingQueue {
 ...
 protected:
  ...
  EYS3D_DISABLE_COPY(BlockingQueue)
  EYS3D_DISABLE_MOVE(BlockingQueue)
};
...
#endif  // EYS3D_INTERNAL_BLOCKING_QUEUE_H_
